package project.valery.SoloRandomizer.exceptions;
...
//    }
    ...
    public static ResponseEntity<Object> handleSequenceNotFoundException(SequenceNotFoundException sequenceNotFoundException) {
        List<String> details = new ArrayList<>();
        details.add(sequenceNotFoundException.getLocalizedMessage());
        ErrorResponse error = new ErrorResponse("Sequence Not Found", details);
        return new ResponseEntity<>(error, HttpStatus.NOT_FOUND);
    }
